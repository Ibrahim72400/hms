<?php
    ...
    if(isset($_POST['add_btn'])) {
        ...
        if(empty($_POST['comment'])){
          $usercommErr = "Please Enter a comment";
          
          }else{
           $cmnt = mysqli_real_escape_string($conn,$_POST['comment']);
           if(mysqli_query($conn,"UPDATE req_to_accountant_therapy set comments='$cmnt'  WHERE id='$id'")){
               $msg = "Succesfully added the comment";
               header("Location: accountant_list_request_therapy.php");
           }
           else{
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="container">
            ...
            <div class="row pt-5">
              ...
              <div class="">
                <span> <input type="text" name="comment" placeholder="add comments"> </span>  <span style=color:red;> <?php echo $usercommErr; ?></span>
              </div>
            ...
            <div class="row pt-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="add_btn" class="btn btn-primary btn-lg" type="submit" >Add Comment</button> <span style="color:red;"><?php echo $msg; ?> </span>
            </div>
            </div>
