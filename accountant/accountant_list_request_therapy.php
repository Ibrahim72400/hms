<?php
    ...
    if(isset($_POST['chs_btn'])) {
        ...
        mysqli_query($conn,"UPDATE req_to_accountant_therapy set status='confirmed'  WHERE id='$id'");
    ...
    if(isset($_POST['cms_btn'])) {
        ...
        $_SESSION["id"] = $id;
                    ...
                    header("Location: add_comments_therapy.php");
                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Therapy's Name</th>
                      <!-- <th scope="col">Blood Group</th> -->
                      <!-- <th scope="col">Gender</th> -->
                      <!-- <th scope="col">Date of Birth</th> -->
                      <th scope="col">Therapy's Price</th>
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from req_to_accountant_therapy");
                    $cnt=1;
                    $color = "" ;
