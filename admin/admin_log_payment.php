<?php
    ...
    $results = mysqli_query($conn, $sql);
     $message =       $uPassErr = $oPassErr = $cPassErr =  $opwd = $pwd = $cpwd = $npwd = $genderErr = $usersector =  $uPassToDb = "";
    ...
    $row= mysqli_fetch_array($results);
     ...
     if(isset($_POST['nxt_btn'])) {
        ...
        header("Location: admin_log_payment_2.php");
          ...
          <div class="container">
            <div class="row pt-3">
              ...
              <div class="col-2">
                ...
                <option value="Diagnosis Centre">Diagnosis Centre</option>
