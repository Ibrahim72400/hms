...
<?php
    ...
    $sql = "select max(userid) from  physio_therapist_info;";
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
      ...
      if(isset($_POST['add_btn'])){
        ...
        $specErr = "Specialization cannot be empty!";
        ...
        if($errExists != 1){
          ...
          $sqlUers = "select userid from physio_therapist_info where userid = '$userid'";
        ...
        $sqlUserInsert = "insert into physio_therapist_info (userid,fullname,password, email, phone, dob, blood_group, gender,  address,therapy_type)
        values ('$userid','$fName','$uPassToDb','$uEmail','$uPhone','$uDob' ,'$userBlood','$userGender', '$uAddress','$userspec');";

        if(mysqli_query($conn, $sqlUserInsert)){

        $msg = "Physio therapist was successfully Added";
          ...
          $msg = "Physio therapist was not added";
        }
      }
    ...
    <div class="container-fluid pb-5">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 ">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Add a Physio Therapist</h1>
          </div>
          ...
          <div class="container">
            ...
            <div class="row pt-3">
              ...
              <div class="col-2">
                ...
                <option selected disabled>Choose...</option>
                <option value="Geriatric Physical Therapy" <?php if($uspec == "Geriatric Physical Therapy") echo "selected" ?>>Geriatric Physical Therapy</option>
                <option value="Sports Physical Therapy"<?php if($uspec == "Sports Physical Therapy") echo "selected" ?>>Sports Physical Therapy</option>
                 <option value="Orthopedic Physiotherapy"<?php if($uspec == "Orthopedic Physiotherapy") echo "selected" ?>>Orthopedic Physiotherapy</option>
                <option value="Pediatric Physical Therapy"<?php if($uspec == "Pediatric Physical Therapy") echo "selected" ?>>Pediatric Physical Therapy</option>
            ...
            <div class="row pt-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="add_btn" class="btn btn-primary btn-lg" type="submit" >Add Therapist</button>  <span style ="color:red;"><?php echo $msg; ?></span>
            </div>
            </div>
