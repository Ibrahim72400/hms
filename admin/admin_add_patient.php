    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
      ...
      if(isset($_POST['add_btn'])){
        ...
        if($errExists != 1){
          ...
          $sqlUers = "select userid from patient_info where userid = '$userid'";
        ...
        values ('$userid','$fName','$uPassToDb','$uEmail','$uPhone','$uDob' ,'$userBlood','$userGender',  '$useral', '$uAddress');";
          ...
          <div class="container">
            ...
            <div class="row pt-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="add_btn" class="btn btn-primary btn-lg" type="submit" >Add Patient</button>  <span style ="color:red;"><?php echo $msg; ?></span>
            </div>
            </div>
