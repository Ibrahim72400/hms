...
<?php
    ...
    mysqli_query($conn,"UPDATE management_info set fullname='" . $_POST['fname'] . "', blood_group='" . $_POST['blood_group'] . "', gender='" . $_POST['gender'] . "' ,email='" . $_POST['email'] . "',phone='" . $_POST['phone'] . "',dob='" . $_POST['dob'] . "',address='" . $_POST['address'] . "'  WHERE userid='$uid'");
    ...
    <div class="container-fluid pb-5">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 ">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Edit a Management Staff</h1>
          </div>
