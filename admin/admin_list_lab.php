...
<?php
    ...
    if(isset($_POST['delete_btn'])){
        ...
        if(mysqli_query($conn,"delete from lab_test_info where id = '$uid'")){
                  $_SESSION["user_id"] = $uid;
                    header("Location: admin_delete_phyio_therapist.php");
    ...
    if(isset($_POST['edit_btn'])){
        ...
        $_SESSION["user_id"] = $uid;
        header("Location: admin_edit_lab_test.php");
    ...
    if(isset($_POST['add_btn'])){
        ...
        header("Location: admin_add_lab_test.php");
          ...
          <div class="container">
            ...
            <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from lab_test_info");
                    $cnt=1;
                    ...
                    <tr>
                      ...
                      <td><button name="edit_btn" type="submit" class="btn btn-success"><i class="fa fa-edit"></i></button> <button name="delete_btn" type="submit" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete ?')"><i class="fa fa-trash"></i></button><input type="hidden" name="id" value="<?php echo $row['id']; ?>"/></td> </form>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
						}?>
            ...
            <div class="row pt-5">
              ...
              <div class="col-12 text-center align-items-center">
                    ...
                    <button name="add_btn" class="btn btn-primary btn-lg" type="submit" >Add a Test</button>  <span style ="color:red;"><?php echo $msg; ?></span>
