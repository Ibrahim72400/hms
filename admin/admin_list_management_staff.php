...
<?php
    ...
    if(isset($_POST['delete_btn'])){
        ...
        if(mysqli_query($conn,"delete from management_info where userid = '$uid'")){
                  $_SESSION["user_id"] = $uid;
                    header("Location: admin_delete_management_staff.php");
    ...
    if(isset($_POST['edit_btn'])){
        ...
        $_SESSION["user_id"] = $uid;
        header("Location: admin_edit_management_staff.php");
    ...
    <div class="container-fluid pb-5">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
            <h1 class="h2">Blood Bank Staffs List</h1>
          </div>
            ...
            <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from management_info");
                    $cnt=1;
