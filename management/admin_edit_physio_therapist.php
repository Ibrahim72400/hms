...
<?php
    ...
    mysqli_query($conn,"UPDATE physio_therapist_info set fullname='" . $_POST['fname'] . "', blood_group='" . $_POST['blood_group'] . "', gender='" . $_POST['gender'] . "' ,email='" . $_POST['email'] . "',phone='" . $_POST['phone'] . "',dob='" . $_POST['dob'] . "',address='" . $_POST['address'] . "' , therapy_type='" . $_POST['spec'] . "'  WHERE userid='$uid'");
    ...
    <div class="container-fluid pb-5">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 ">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Edit a Physio Therapist</h1>
          </div>
          ...
          <div class="container">
            ...
            <div class="row pt-3">
              ...
              <div class="col-2">
                ...
                <option selected value="<?php echo htmlentities($row['therapy_type']);?>"><?php echo htmlentities($row['therapy_type']);?></option>
            ...
            <div class="row pt-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="add_btn" class="btn btn-primary btn-lg" type="submit" >Edit Physio Therapy</button>  <span style ="color:red;"><?php echo $message; ?></span>
            </div>
            </div>
