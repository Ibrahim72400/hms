...
<?php
    ...
    if(isset($_POST['add_btn'])){
        ...
        $_SESSION["user_id"] = $uid;
        header("Location: admin_add_n_appointments.php");
    ...
    <div class="container-fluid pb-5">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
            <h1 class="h2">Nurse Appointments</h1>
          </div>
            ...
            <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from appointments_nurse");
                    $cnt=1;
                    ...
                    <tr>
                      ...
                      <td class="center"><?php echo $cnt;?>.</td>
                        <td class="hidden-xs"><?php echo $row['nid'];?></td>
              ...
              <div class=""> <button name="add_btn" type="submit" class="btn btn-primary"> Add Appointments </button></div>
