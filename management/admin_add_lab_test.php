...
<?php
    ...
    $Pass = $fName = $uEmail = $uPass =  $uPhone = $statuserr = $userstatus =  $uDob = $spec = $tname = $userGender = $userBlood = $usertest = $testuserr = $userspec = $uPassToDb = $days = $degree = $dd =  $dg = $userid = $fees = $userTimeErr = $errExists = $userIdErr = $userPassErr = $userFnameErr = $userEmailErr = $userPhoneErr = $userAddErr = $userAddErr = $userDobErr = $userTimeErr = $userFeesErr = $time =  $etime = $stime = "" ;
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
      ...
      if(isset($_POST['add_btn'])){
          ...
          $dy = mysqli_real_escape_string($conn,$_POST['dy']);
        ...
        if(empty($_POST['status']) and empty($_POST['ttype'])){
        
        $statuserr = "Status cannot be empty!";
        $testuserr = "Test Type cannot be empty!";
        $errExists = 1;
        }else{
        
        $userstatus = mysqli_real_escape_string($conn, $_POST['status']);
        $usertest = mysqli_real_escape_string($conn, $_POST['ttype']);
        }
        ...
        if($errExists != 1){
          ...
          $sqlUers = "select test_name from lab_test_info where test_name = '$tname'";
          $results = mysqli_query($conn, $sqlUers);

          $rowCount = mysqli_num_rows($results);

          if($rowCount > 0){
            $userFnameErr = "Test already exists!";
        ...
        $sqlUserInsert = "insert into lab_test_info (test_name,test_type,price,days,time,status)
        values ('$tName','$usertest','$fees','$dy','$time', '$userstatus');";

        if(mysqli_query($conn, $sqlUserInsert)){

        $msg = "Test was successfully Added";
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 ">
          ...
          <div class="container">
            ...
            <div class="row pt-3">
              ...
              <div class="">
                <input type="text" name="tname" value="" placeholder="Test Name"> <span style="color:red;"> <?php echo $userFnameErr; ?> </span>
              </div>
            ...
            <div class="row pt-3">
              ...
              <div class="col-2">
                ...
                <span style="color:red;"> <?php echo $testuserr; ?> </span>
              </div>
            ...
            <div class="row pt-3">
              ...
              <div class="col-2" style="white-space:nowrap;">
                <input type="text" name="dy" value="Everyday" readonly="readonly" > <span style="color:red;">  </span>
            ...
            <div class="row pt-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="add_btn" class="btn btn-primary btn-lg" type="submit" >Add Lab Test</button>  <span style ="color:red;"><?php echo $msg; ?></span>
            </div>
            </div>
