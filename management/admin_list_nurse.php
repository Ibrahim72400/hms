...
<?php
    ...
    if(isset($_POST['delete_btn'])){
        ...
        if(mysqli_query($conn,"delete from nurse_info where userid = '$uid'")){
                  $_SESSION["user_id"] = $uid;
                    header("Location: admin_delete_nurse.php");
    ...
    if(isset($_POST['edit_btn'])){
        ...
        $_SESSION["user_id"] = $uid;
        header("Location: admin_edit_nurse.php");
            ...
            <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from nurse_info");
                    $cnt=1;
