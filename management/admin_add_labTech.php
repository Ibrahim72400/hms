...
<?php
    ...
    $Pass = $fName = $uEmail = $uPass =  $uPhone = $uDob = $genderErr = $bloodErr = $specErr = $spec = $userAllergy = $userGender = $useral = $al = $userBlood = $userspec = $uPassToDb = $days = $degree = $dd =  $dg = $userid = $fees = $userTimeErr = $errExists = $userIdErr = $userPassErr = $userFnameErr = $userEmailErr = $userPhoneErr = $userAddErr = $userAddErr = $userDobErr = $userTimeErr = $userFeesErr = $time =  $etime = $stime = "" ;



    $sql = "select max(userid) from  lab_staff_info;";
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
      ...
      if(isset($_POST['add_btn'])){
        ...
        $specErr = "Specialty cannot be empty!";
        ...
        if($errExists != 1){
          ...
          $sqlUers = "select userid from lab_staff_info where userid = '$userid'";
        ...
        $sqlUserInsert = "insert into lab_staff_info (userid,fullname,password, email, phone, dob, blood_group, gender,  address,specialty)
        values ('$userid','$fName','$uPassToDb','$uEmail','$uPhone','$uDob' ,'$userBlood','$userGender', '$uAddress','$spec');";
    ...
    <div class="container-fluid pb-5">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 ">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Add a Lab Staff</h1>
          </div>
          ...
          <div class="container">
            ...
            <div class="row pt-3">
              ...
              <span style="color:red;"> <?php echo $specErr; ?> </span> 
