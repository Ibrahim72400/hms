...
<html lang="en">
  ...
  <body>
    <nav class="navbar flex-md-nowrap p-0 shadow" style="background-color: #99C2FF; color: white; opacity: 0.7;">
    ...
    <div class="container-fluid">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="container">
            <div class="text-center align-middle" style="padding-top: 200px"><p style="font-size: 500%;font-family: cursive;">Profile Deleted [Userid: <?php echo $_SESSION['user_id']; ?>]</p></div> 
          </div>
