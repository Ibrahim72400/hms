...
<?php
    ...
    if(isset($_POST['delete_btn'])){
        ...
        if(mysqli_query($conn,"delete from lab_staff_info where userid = '$uid'")){
    ...
    if(isset($_POST['edit_btn'])){
        ...
        $_SESSION["user_id"] = $uid;
        header("Location: admin_edit_lab_staff.php");
            ...
            <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from lab_staff_info");
                    $cnt=1;
