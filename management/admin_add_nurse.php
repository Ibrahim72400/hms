...
<?php
    ...
    $sql = "select max(userid) from  nurse_info;";
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
      ...
      if(isset($_POST['add_btn'])){
        ...
        if($errExists != 1){
          ...
          $sqlUers = "select userid from nurse_info where userid = '$userid'";
        ...
        $sqlUserInsert = "insert into nurse_info (userid,fullname,password, email, phone, dob, blood_group, gender,  address)
        values ('$userid','$fName','$uPassToDb','$uEmail','$uPhone','$uDob' ,'$userBlood','$userGender', '$uAddress');";

        if(mysqli_query($conn, $sqlUserInsert)){

        $msg = "Nurse was successfully Added";
          ...
          <div class="container">
            ...
            <div class="row pt-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="add_btn" class="btn btn-primary btn-lg" type="submit" >Add Nurse</button>  <span style ="color:red;"><?php echo $msg; ?></span>
            </div>
            </div>
