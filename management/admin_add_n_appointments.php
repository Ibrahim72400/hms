...
<?php
    ...
    if(isset($_POST['chs_btn'])){
        ...
        $_SESSION["n_id"] = $uid;
        header("Location: admin_add_appointment_n_2.php");
    ...
    <div class="container-fluid pb-5">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
            <h1 class="h2">Please Select a Nurse to Appoint</h1>
          </div>
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><button name="chs_btn" type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i></button> <input type="hidden" name="id" value="<?php echo $row['userid']; ?>"/></td> </form>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
						}?>
