  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="container">
            <div class="text-center align-middle" style="padding-top: 200px"><p style="font-size: 500%;font-family: fantasy;font-weight:bold;">Welcome <?php echo $row['fullname']; ?></p></div>
          </div>
