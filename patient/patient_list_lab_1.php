<?php
    ...
    $Pass = $fName = $uEmail = $uPass =  $uPhone = $uDob = $spec = $type = $userGender = $userAllergy = $userBlood = $userspec = $uPassToDb = $days = $degree = $dd =  $dg = $userid = $fees = $userTimeErr = $errExists = $userIdErr = $userPassErr = $userFnameErr = $userEmailErr = $userPhoneErr = $userAddErr = $userAddErr = $userDobErr = $userTimeErr = $userFeesErr = $time =  $etime = $stime = $userAdd = "" ;
    ...
    if(isset($_POST['chs_btn'])) {
        ...
        $_SESSION["id"] = $uid;
        header("Location: patient_list_lab_2.php");
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Choose A Lab Test</h1>
          </div>
            ...
            <div class="row pt-5">
              ...
              <div class="col-12">
               <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from lab_test_info where test_type='$type'");
                    $cnt=1;
                    ...
                    <tr>
                      ...
                      <td><button name="chs_btn" type="submit" class="btn btn-light" onClick="return confirm('Are you sure you want to proceed ?')"><i class="far fa-check-circle"></i><input type="hidden" name="id" value="<?php echo $row['id']; ?>"/></td> </form>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
						}?>
