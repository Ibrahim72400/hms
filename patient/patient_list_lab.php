<?php
    ...
    if(isset($_POST['nxt_btn'])) {
        ...
        if(empty($_POST['ttype'])){
            ...
            $spec = "Test cannot be empty!";

        }

        else{

            $userspec = mysqli_real_escape_string($conn, $_POST['ttype']);
            $_SESSION["type"] = $userspec;
            header("Location: patient_list_lab_1.php");
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Choose A Test Type</h1>
          </div>
          ...
          <div class="container">
            ...
            <div class="row pt-5 pb-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="nxt_btn" class="btn btn-primary btn-lg" type="submit" > Next </button> <span style="color:red;"> <?php echo $spec; ?></span>
            </div>
            </div>
