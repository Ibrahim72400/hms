<?php
    ...
    $sql2 = "select * from lab_test_info where id='$did' ;";
    ...
    if(isset($_POST['nxt_btn'])) {
        ...
        if(empty($_POST['phone']) and empty($_POST['trx']) and empty($_POST['payment'])){
            ...
            $sqlUserInsert = "insert into req_to_accountant_test (pid,tid,pname,tname,price,day, time,date, payment_method,sender_number,trx_id,status,comments,p_date_time)
            values ('$uid','$did','".$row1['fullname']."','".$row2['test_name']."','".$row2['price']."',  '".$_SESSION["day"]."',  '".$_SESSION["time"]."','".$_SESSION["date"]."','".$userpayment."','".$userphone."','".$usertrx."','waiting', 'none',NOW());";

            if(mysqli_query($conn, $sqlUserInsert)){

                header("Location: patient_list_lab_4.php");
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="container">
            ...
            <div class="row pt-1"><div class="" style="color:blue;">➼ Please Give input "Test" in the Reference</div> </div>
