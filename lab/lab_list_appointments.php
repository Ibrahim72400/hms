<?php
 ...
 $uspec = $degree = $msg = "" ;
    ...
    if(isset($_POST['cncl_btn'])) {
        ...
        mysqli_query($conn,"UPDATE req_to_accountant_test set status='canceled by lab'  WHERE id='$id'");
    ...
    } elseif ($_FILES['report']['size'] > 1000000) { // file shouldn't be larger than 1Megabyte
        echo "File too large!";
    } else {
        // move the uploaded (temporary) file to the specified destination
        if (move_uploaded_file($file, $destination)) {
            $sql = "INSERT INTO reports (name, size, downloads,rid) VALUES ('$filename', $size, 0,'$id')";
    ...
    if(isset($_POST['vst_btn'])) {
        ...
        mysqli_query($conn,"UPDATE req_to_accountant_test set status='tested'  WHERE id='$id'");
    // $message = "Record Modified Successfully";
    header("Refresh:1");
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Lab Test </h1>
            <div style="color:red;"> Note: First Upload the report then click "done".</div>
          </div>
           ...
           <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from req_to_accountant_test where status='confirmed'");
                    $cnt=1;
                    ...
                    <tr>
                      ...
                      <td class="center"><?php echo $cnt;?>.</td>
                        ...
                        <td style="white-space:nowrap;"> <input type="file" name="report"> <button type="submit" name="upload" class="btn btn-dark">Upload</button><input type="hidden" name="id" value="<?php echo $row['id']; ?>"/></td> </form></td>
