<?php
 ...
 $uspec = $degree = $msg = "" ;
   ...
   if(isset($_POST['cncl_btn'])) {
        ...
        mysqli_query($conn,"UPDATE blood_bank_request set status='not available'  WHERE id='$id'");
...
if(isset($_POST['vst_btn'])) {
        ...
        mysqli_query($conn,"UPDATE blood_bank_request set status='available'  WHERE id='$id'");
    // $message = "Record Modified Successfully";
    header("Refresh:1");
    ...
    if(isset($_POST['dne_btn'])) {
        $id = $_POST['id'];


        mysqli_query($conn,"UPDATE blood_bank_request set status='donated'  WHERE id='$id'");
    // $message = "Record Modified Successfully";
    header("Refresh:1");
             ...
             <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from blood_bank_request where status='waiting' or status='available'");
                    $cnt=1;
