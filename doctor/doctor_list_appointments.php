            ...
            <div class="row row-content align-items-center">
              ...
              <div class="col-12">
                ...
                <table class="table table-hover">
                  ...
                  <?php
                    $sql=mysqli_query($conn,"select * from req_to_accountant where did='$uid' and status='confirmed' or status='canceled by doctor'");
                    $cnt=1;
                    ...
                    while($row1=mysqli_fetch_array($sql)){  echo date_diff(date_create($row1['dob']), date_create('today'))->y;}?> </td>
                      ...
                      <td><button name="vst_btn" type="submit" class="btn btn-success" onClick="return confirm('Are you sure you want to proceed ?')">Visited <button name="cncl_btn" type="submit" class="btn btn-info ml-1" >Cancel<input type="hidden" name="id" value="<?php echo $row['id']; ?>"/></td> </form>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
						}?>
