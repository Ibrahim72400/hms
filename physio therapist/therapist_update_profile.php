<?php
 ...
 $uspec = $degree = $msg = "" ;
    ...
    if(isset($_POST['edit_btn'])) {
       ...
       mysqli_query($conn,"UPDATE physio_therapist_info set fullname='" . $_POST['fname'] . "', blood_group='" . $_POST['blood_group'] . "', gender='" . $_POST['gender'] . "' ,email='" . $_POST['email'] . "',phone='" . $_POST['phone'] . "',dob='" . $_POST['dob'] . "',address='" . $_POST['address'] . "'  WHERE userid='$uid'");
  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Physio Therapist Profile</h1>
          </div>
          ...
          <div class="container">
            ...
            <div class="row pt-5 pb-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="edit_btn" class="btn btn-primary btn-lg" type="submit" >Update </button> <span style="color:red;"> <?php echo $message; ?> </span>  
            </div>
            </div>
          </div>
            </form>
